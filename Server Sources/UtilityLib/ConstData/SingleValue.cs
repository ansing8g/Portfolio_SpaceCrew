...
namespace UtilityLib.ConstData.SingleValue
{
        ...
        where DataType : class
    {
        ...
        {
            m_dicData = new Dictionary<Key, DataType?>();
        }
        ...
        public bool Load_File(string _pathCSVFile, DataParser _funcParser, bool _parsingHeaderPass = true)
        {
            try
            {
                ...
                foreach (string strData in listData)
                {
                    ...
                    {
                        m_dicData.Add(key, dataType);
                    }
                    else
                    {
                        m_dicData[key] = dataType;
                    }
                }
            }
            catch
        ...
        public bool GetValue(Key _key, out DataType? _value)
        {
            _value = null;
        ...
        private Dictionary<Key, DataType?> m_dicData;
    }
}
